...
namespace Travail_fin_de_session
{
    ...
    public sealed partial class modifierClient : Page
    {
        public modifierClient()
        {
            ...
            nomClient.Text = listeClient.indexClient.Nom;
            prenomClient.Text = listeClient.indexClient.Prenom;
            telClient.Text = listeClient.indexClient.Telephone; ;
            posteClient.Text = listeClient.indexClient.Poste;
            bureauClient.Text = listeClient.indexClient.Bureau;
            typeClient.Items.Add(listeClient.indexClient.Type);
            emailClient.Text = listeClient.indexClient.Email;
